# Form implementation generated from reading ui file 'qt_ui\subject.ui'
#
...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        self.radioYes = QtWidgets.QRadioButton(parent=self.groupBox_2)
        self.radioYes.setObjectName("radioYes")
        self.horizontalLayout_2.addWidget(self.radioYes)
        self.radioNo = QtWidgets.QRadioButton(parent=self.groupBox_2)
        ...
        self.radioAny = QtWidgets.QRadioButton(parent=self.groupBox)
        ...
        self.lineEditDescription = QtWidgets.QLineEdit(parent=Dialog)
